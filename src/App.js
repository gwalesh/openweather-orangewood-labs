...
const API_KEY = "1320214660ae19b54edcf586df165a9e";
...
class App extends Component {
  ...
  state = {
    ...
    const data = await fetch(`https://api.openweathermap.org/data/2.5/forecast?q=${city},${country}&appid=1320214660ae19b54edcf586df165a9e&units=metric`)
                      .then(this.setState({
                        loading: true
                      }))     
                      .then((data) => {
